use rlua::{prelude::*, UserDataMethods, UserData, MetaMethod};
...
pub fn sign(_: LuaContext, this: &LuaSecretKey, msg: String) -> Result<String, LuaError> {
...
pub fn verify(_: LuaContext, this: &LuaPublicKey, base64_msg: String) -> Result<String, LuaError> {
...
pub fn verify_detached(_: LuaContext, this: &LuaPublicKey, (msg, base64_signature): (String, String)) -> Result<bool, LuaError> {
...
pub fn new_keypair(_lua: LuaContext, _: ()) -> LuaResult<(LuaSecretKey, LuaPublicKey)> {
    let (pk, sk) = sign::gen_keypair();
    Ok((LuaSecretKey(sk), LuaPublicKey(pk)))
}

/// Constructs and returns a LuaSecretKey object from it's base64 string encoding
pub fn load_secret(_: LuaContext, base64_key: String) -> Result<LuaSecretKey, LuaError> {
...
pub fn load_public(_: LuaContext, base64_key: String) -> Result<LuaPublicKey, LuaError> {
    base64::decode(&base64_key).map_err(Error::from)
