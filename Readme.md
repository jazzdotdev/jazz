...
Read on for more about Torchbear's functions.  **Note:** every module is completely built-in, coded in pure Rust, or otherwise wrapping a [C](https://en.wikipedia.org/wiki/C_(programming_language)) library, safely (noted with an asterisk*).
